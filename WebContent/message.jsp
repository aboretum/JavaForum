...
<% String sessionType = (String)session.getAttribute("member_title"); %>
...
<% if( sessionUsername != null){%>
	...
	<% String titleAdmin = "Posted On: " + date_time + "&nbsp;&nbsp;&nbsp;<a href=\"./index.jsp?page=editmessage&forum_id=" + forum_id + "&thread_id=" + thread_id + "&reply_id=" + reply_id + "&start=" + start + "\">Edit</a>&nbsp;&nbsp;&nbsp;<a href=\"DeleteReply?forum_id=" + forum_id + "&thread_id=" + thread_id + "&reply_id=" + reply_id + "&start=" + start + "\">Delete</a>"; %>
	...
	%>									
			...
			<b><a href= "./viewprofile.jsp?username=<%= user%>"><%= user %> </a></b>
			<br>
			<%= member_title %><br>
			<%= avatar %><br>
	...
	<form action="AddReply" method="POST" name="formmessage">
